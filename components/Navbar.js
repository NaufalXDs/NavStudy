        ...
        <div class="w-full flex items-center justify-end ml-auto sm:justify-between sm:gap-x-3 sm:order-3">
          ...
          <div class="mx-auto">
            ...
            <div class="relative">
              ...
              <input type="text" id="icon" name="icon" class="py-2 px-4 pl-11 pr-20 block w-40 md:w-96 bg-transparent border-gray-700 shadow-sm rounded-md text-sm text-gray-300 focus:z-10 focus:border-gray-900 focus:ring-gray-600 placeholder:text-gray-500" placeholder="Search" />
